...
var onFormEscPress = function (evt) {
  if (evt.keyCode === ESC_KEYCODE && inputFieldHashtag !== document.activeElement && textareaField !== document.activeElement) {
    closeForm();
  }
};
...
var openForm = function () {
  ...
  btnSubmitForm.addEventListener('click', onFieldHashtagInput);
};
...
var closeForm = function () {
  ...
  btnSubmitForm.removeEventListener('click', onFieldHashtagInput);
};
